...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_pic_url', models.URLField(blank=True, default='/media/images/profile_pictures/pfpic1.jpeg', max_length=500, null=True)),
                ('cover_pic_url', models.URLField(blank=True, default='/media/images/cover_pictures/coverpic2.jpeg', max_length=500, null=True)),
