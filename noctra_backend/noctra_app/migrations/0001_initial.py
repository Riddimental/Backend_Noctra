...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_pic_url', models.URLField(blank=True, default='/media/images/profile_pictures/default_profile.jpg', max_length=500, null=True)),
                ('cover_pic_url', models.URLField(blank=True, default='/media/images/cover_pictures/default_cover.jpg', max_length=500, null=True)),
                ('date_of_birth', models.DateField(blank=True, null=True)),
                ('is_vip', models.BooleanField(default=False)),
                ('id_verification_url', models.URLField(blank=True, max_length=500, null=True)),
